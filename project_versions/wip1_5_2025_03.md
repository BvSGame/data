...
| [◀️ 1.5: Feb 2025](/project_versions/wip1_5_2025_02.md) | [2.0 ▶️](/project_versions/wip2_0.md) |
| --: | :-- |
...
- Becoming more accessible for artists, with the introduction of the [Document for Artists](/design_art/document_for_artists.md).
- Expanding the list of stories for [BvS Origins](/story/bvso/readme.md).
- Further establishing versioning for a whole project.
- One of the biggest update for `data` repository, during [0.1.5.8](#0158) version.
...
- **Data**
  - [Main page](/README.md) got disclaimer about blank pages that this repository contains.
...
- **Data**
  - For monthly change logs, there is a new practice of adding Overviews, starting with the [March 2025 edition](#overview).
  - [Main page](/README.md) – removed centering due to the incompatibility with some Markdown parsers (particularly Jekyll).
...
- **Data** – ONE WHOPPER of an update!
  ...
  - EVERY Markdown file (old and new) in this repository got following updates:
    ...
    - Serialized pages, like [BvS 1 story chapters](/story/bvs1/readme.md), have additional “Previous/Next” navigational links.
  - New info:
